...
public class InquiryCompleteAction extends ActionSupport implements SesseionAware{

	private String name;
	private String qtype;
	private String body;

	List<InuiqryDTO> inquiryDTOList = new ArrayList<InquiryDTO>();
	private Map<String, Object> session;

	public String execute(){
		String ret=ERROR;
		com.internousdev.webproj5.dao.InquiryCompleteDAO dao = new InquiryCompleteDAO();

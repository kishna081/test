...
public class MyPageDAO {
	...
	public MyPageDTO getMyPageUserInfo(String item_transaction_id,String user_master_id)throws SQLException{
		...
		String sql="SELECT iit.item_name,ubit.total_price,ubit_total_count,ubit.pay FROM uesr_buy_item_transaction ubit LEFT JOIN item_info_transaction iit ON ubit.item_transaction_id = iit.id HWERE ubit.item_transaction_id= ? AND ubit.user_master_id = ? ORDER BY ubit.insert_date DESC";
